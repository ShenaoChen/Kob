                            ...
                            <tbody>
                                <tr v-for="bot in bots" :key="bot.id">
                                    ...
                                    <td>
                                        ...
                                        <div class="modal fade modal-xl" :id="'update-bot-modal-' + bot.id" tabindex="-1">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                <div class="modal-header">
...
export default {
    ...
    setup() {
        ...
        const add_bot = () => {
            ...
            $.ajax({
                url: "https://app4121.acapp.acwing.com.cn/api/user/bot/add/",
                type: "post",
                data: {
                    title: botadd.title,
        ...
        const remove_bot = (bot) => {
            botadd.error_message = "";
            $.ajax({
                url: "https://app4121.acapp.acwing.com.cn/api/user/bot/remove/",
                type: "post",
                data: {
                    bot_id: bot.id,
                },
        ...
        const update_bot = (bot) => {
            botadd.error_message = "";
            $.ajax({
                url: "https://app4121.acapp.acwing.com.cn/api/user/bot/update/",
                type: "post",
                data: {
                    bot_id: bot.id,
                    title: bot.title,
